...
public class SessionServicesConvertimagesPost200Response {
  ...
  public SessionServicesConvertimagesPost200Response() {
  }

  public SessionServicesConvertimagesPost200Response returnStatus(ReturnStatusBody returnStatus) {
  ...
  **/
  ...
  public SessionServicesConvertimagesPost200Response id(String id) {
  ...
  **/
  ...
  public SessionServicesConvertimagesPost200Response serviceName(String serviceName) {
  ...
  **/
  ...
  public SessionServicesConvertimagesPost200Response executionMilliSeconds(String executionMilliSeconds) {
  ...
  **/
  ...
  public SessionServicesConvertimagesPost200Response licenseUsedPercent(Integer licenseUsedPercent) {
  ...
  **/
  ...
  public SessionServicesConvertimagesPost200Response licensePagesUsed(Integer licensePagesUsed) {
  ...
  **/
  ...
  public SessionServicesConvertimagesPost200Response licensePagesUsed2(Integer licensePagesUsed2) {
  ...
  **/
  ...
  public SessionServicesConvertimagesPost200Response resultItems(List<BasicResultItemWithValuesAndFiles> resultItems) {
    
    this.resultItems = resultItems;
    return this;
  }

  public SessionServicesConvertimagesPost200Response addResultItemsItem(BasicResultItemWithValuesAndFiles resultItemsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SessionServicesConvertimagesPost200Response sessionServicesConvertimagesPost200Response = (SessionServicesConvertimagesPost200Response) o;
    return Objects.equals(this.returnStatus, sessionServicesConvertimagesPost200Response.returnStatus) &&
        Objects.equals(this.id, sessionServicesConvertimagesPost200Response.id) &&
        Objects.equals(this.serviceName, sessionServicesConvertimagesPost200Response.serviceName) &&
        Objects.equals(this.executionMilliSeconds, sessionServicesConvertimagesPost200Response.executionMilliSeconds) &&
        Objects.equals(this.licenseUsedPercent, sessionServicesConvertimagesPost200Response.licenseUsedPercent) &&
        Objects.equals(this.licensePagesUsed, sessionServicesConvertimagesPost200Response.licensePagesUsed) &&
        Objects.equals(this.licensePagesUsed2, sessionServicesConvertimagesPost200Response.licensePagesUsed2) &&
        Objects.equals(this.resultItems, sessionServicesConvertimagesPost200Response.resultItems);
  }
  ...
  public String toString() {
    ...
    sb.append("class SessionServicesConvertimagesPost200Response {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to SessionServicesConvertimagesPost200Response
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SessionServicesConvertimagesPost200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SessionServicesConvertimagesPost200Response is not found in the empty JSON string", SessionServicesConvertimagesPost200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SessionServicesConvertimagesPost200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SessionServicesConvertimagesPost200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SessionServicesConvertimagesPost200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SessionServicesConvertimagesPost200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SessionServicesConvertimagesPost200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SessionServicesConvertimagesPost200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<SessionServicesConvertimagesPost200Response>() {
           @Override
           public void write(JsonWriter out, SessionServicesConvertimagesPost200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SessionServicesConvertimagesPost200Response read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SessionServicesConvertimagesPost200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SessionServicesConvertimagesPost200Response
  * @throws IOException if the JSON string is invalid with respect to SessionServicesConvertimagesPost200Response
  */
  public static SessionServicesConvertimagesPost200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SessionServicesConvertimagesPost200Response.class);
  }

 /**
  * Convert an instance of SessionServicesConvertimagesPost200Response to an JSON string
  *
  * @return JSON string
  */
