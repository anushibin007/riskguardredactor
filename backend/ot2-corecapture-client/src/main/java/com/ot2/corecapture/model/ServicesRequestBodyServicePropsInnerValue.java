...
public class ServicesRequestBodyServicePropsInnerValue extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ServicesRequestBodyServicePropsInnerValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ServicesRequestBodyServicePropsInnerValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ServicesRequestBodyServicePropsInnerValue>() {
                @Override
                public void write(JsonWriter out, ServicesRequestBodyServicePropsInnerValue value) throws IOException {
                ...
                @Override
                public ServicesRequestBodyServicePropsInnerValue read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ServicesRequestBodyServicePropsInnerValue ret = new ServicesRequestBodyServicePropsInnerValue();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ServicesRequestBodyServicePropsInnerValue: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ServicesRequestBodyServicePropsInnerValue() {
        super("oneOf", Boolean.FALSE);
    }

    public ServicesRequestBodyServicePropsInnerValue(BigDecimal o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ServicesRequestBodyServicePropsInnerValue(Boolean o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ServicesRequestBodyServicePropsInnerValue(Integer o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ServicesRequestBodyServicePropsInnerValue(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return ServicesRequestBodyServicePropsInnerValue.schemas;
    }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ServicesRequestBodyServicePropsInnerValue
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ServicesRequestBodyServicePropsInnerValue with oneOf schemas: BigDecimal, Boolean, Integer, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
    }
  }

 /**
  * Create an instance of ServicesRequestBodyServicePropsInnerValue given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ServicesRequestBodyServicePropsInnerValue
  * @throws IOException if the JSON string is invalid with respect to ServicesRequestBodyServicePropsInnerValue
  */
  public static ServicesRequestBodyServicePropsInnerValue fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServicesRequestBodyServicePropsInnerValue.class);
  }

 /**
  * Convert an instance of ServicesRequestBodyServicePropsInnerValue to an JSON string
  *
  * @return JSON string
  */
